...
import 'package:travel/modules/HomeScreen/Booking.dart';
import 'package:travel/modules/HomeScreen/hotelsReview.dart';
...
class HotelDetails extends StatelessWidget {
  ...
  HotelDetails(this.model, {Key? key}) : super(key: key);
                  ...
                  body: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                                        ...
                                        children: [
                                          InkWell(
                                             onTap: (){
                                              ...
                                              navigateTo(context,  HotelsReview(model));
                                             },
                                            child: Container(
                                              padding: EdgeInsets.all(10),
                        ...
                        FirebaseAuth.instance.currentUser!.uid.toString()!=systemId? Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Container(
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          InkWell(
                                             onTap: (){
                                               if(model.availableRome!='0'){
                                                 navigateTo(context, Booking(model));
                                               }
                                             else{
                                               showToast(text: 'There are no rooms available ', state:ToastStates.ERROR);
                                               }
                                             },
                                            child: Container(
                                              padding: EdgeInsets.all(10),
