...
class AddTourist extends StatelessWidget {
  const AddTourist({Key? key}) : super(key: key);
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: const Text('Add Tourist Place'),
              centerTitle: true,
              elevation: 0,
            ),
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          else if (int.parse(cubit.rateHotelController.text)>10){
                              ...
                              if (AuthenticationCubit.get(context).postImage ==
                                ...
                                if (AuthenticationCubit.get(context)
                                  ...
                                  if (AuthenticationCubit.get(context)
                                      ...
                                      .currentState!
                                      .validate()) {
                                    AuthenticationCubit.get(context).addTourist(
                                      context,
